...
module.exports = {
    ...
    callback: async ({ sock, m, prefix, thePrefix }) => {
        ...
        const thumbnail = await getBuffer(logonya.isLogo? logonya.url : "https://github.com/MR-NC/P/blob/09ddad34c1acd4bbe498f8e239f8655daf5ce6c0/FB_IMG_1687239587669.jpg" + randomNomor(10) + ".jpg")
        let options = {
        externalAdReply: {
